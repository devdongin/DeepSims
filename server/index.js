...
import {publicServiceSummary} from '../sim/public-service-observation.js';
...
app.get('/api/industry', (_req, res) => {
  ...
  res.json({
    ...
    publicServices: publicServiceSummary(engine.world),
