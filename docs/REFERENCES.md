...
| Everyday Political Talk with Strangers: Evidence on a Neglected Arena of the Deliberative System | Rüdiger Schmitt-Beck, Christian Schnaudt | 2023 | **CC BY 4.0** (조판본 라이선스 문단 직접 추출 — "Open Access This article is licensed under a Creative Commons Attribution 4.0 International License"; © The Author(s) 2023) | [DOI 10.1007/s11615-023-00462-6](https://doi.org/10.1007/s11615-023-00462-6) · [EconStor 조판본 PDF](https://www.econstor.eu/bitstream/10419/307067/1/s11615-023-00462-6.pdf) | **§22.34** 일상 정치 대화의 의견 유보 — 논문 본문(515쪽) 그대로: "participants of such talks tend to avoid clear opinion statements if they entail the prospect of open disagreement". 초록의 핵심 발견은 낯선 사이의 정치 대화가 이론의 예상과 달리 **오히려 화기애애하다**는 것이고, 참여를 가르는 것은 정치적 성향보다 **사회적 신뢰와 갈등 성향**이었다. politics 대사를 "의견 유보 · 상대 떠보기 · 동네 일로 내려앉기"로 넓히고, 받는 말도 같이 유보하게 만든 근거 | Springer 페이지는 쿠키 벽이라 라이선스 문구가 안 보였다(§4.2). EconStor에 올라온 **출판사 조판본**의 라이선스 문단을 직접 읽어 판정했다 — EconStor 자체 이용약관은 재배포를 제한하지만, 그 약관도 CC 라이선스가 있으면 그쪽이 우선한다고 명시한다 |
| O*NET 31.0 Database — Work Context (직업별 근무 맥락 실측) | U.S. Department of Labor, Employment and Training Administration (USDOL/ETA) | 2026 | **CC BY 4.0** (O*NET Resource Center 라이선스 페이지 직접 확인) | [O*NET Resource Center 라이선스](https://www.onetcenter.org/license_db.html) · [O*NET OnLine](https://www.onetonline.org/) | **§22.33** 직업별 work_gripe 대사 — 무엇을 힘들다고 말하는지가 직업마다 다르다는 것을 911개 직업의 Work Context 실측값으로 확인했다. 간호사(29-1141.00): 타인의 건강·안전 책임 '매우 높음' 66% · 감염 노출 매일 61% · 오류의 결과 '매우 심각' 57% · 화난 사람 상대 매일 42%. 조립생산직(51-2092.00): 손 사용 85% · 반복 동작 48% · 보호장구 매일 91% · 소음 매일 52% · 정확성 '매우 중요' 77%. 입법직(11-1031.00): 리더십 100 · 청렴 98, 주 업무가 상충하는 이해의 조정. 이 값들에 맞춰 다섯 직업의 대사를 썼다 | 필수 표기: "This page includes information from the O*NET 31.0 Database by the U.S. Department of Labor, Employment and Training Administration (USDOL/ETA). Used under the CC BY 4.0 license." 수치를 문장으로 재서술했을 뿐 데이터를 저장소에 두지 않았다 |
...
| Phatic communion (Handbook of Pragmatics 항목) | Gunter Senft | 2009 | All rights reserved (John Benjamins 핸드북 항목 — 저작권 줄을 본문에서 찾지 못해 **보수적으로 유보 분류**) | [MPG PuRe 사본](https://pure.mpg.de/rest/items/item_68366_5/component/file_468107/content) | **§22.38** 날씨 얘기의 본령 — Malinowski가 이 개념을 만들며 든 예가 바로 "inquiries about health, comments on weather"와 인사말이었다. 인용된 Malinowski(1936: 314-316)의 요지: 교감적 언어의 말은 "fulfil a social function and that is their principal aim"이고 "does not serve any purpose of communicating ideas"이며, 'Nice day to-day'류는 "마주 서서 침묵할 때의 낯설고 불편한 긴장을 넘기기 위해" 필요하다. 첫 마디 뒤에는 "comments on what is [obvious]"가 이어진다. 날씨 대사에 침묵 깨기·뻔한 것 논평·동조 요구를 더한 근거 | MPG PuRe에 올라온 사본을 **읽어서** 인용했고 저장소에 두지 않았다. Malinowski 인용문은 이 항목이 인용한 것을 재인용한 것이다 |
| Older Parent–Child Relationships in Six Developed Nations: Comparisons at the Intersection of Affection and Conflict | Merril Silverstein, Daphna Gans, Ariela Lowenstein, Roseann Giarrusso, Vern L. Bengtson | 2010 | All rights reserved — PMC 사본은 **NIH 저자 원고**(NIHMSID NIHMS597568)이고 PMC Open Access 서브셋에 없다(OA 서비스 404). CC 라이선스 없음 | [DOI 10.1111/j.1741-3737.2010.00745.x](https://doi.org/10.1111/j.1741-3737.2010.00745.x) · [PMC4507812](https://pmc.ncbi.nlm.nih.gov/articles/PMC4507812/) | **§22.35** 가족 관계의 네 부류 — 애정과 갈등 두 축의 잠재계층분석에서 amicable(화목, 애정↑갈등↓) ~61% · detached(소원, 둘 다↓) ~23% · disharmonious(불화, 애정↓갈등↑) ~9% · **ambivalent(양가, 둘 다↑) ~8%**로 갈린다. 즉 가족 관계의 약 40%는 그냥 따뜻하지 않다. family_talk 대사 11줄이 전부 화목이던 것을 이 비율로 넓힌 근거 | 읽는 것은 자유지만 재배포 권한은 없다(저자 원고, 출판사 저작권). 수치와 계층 이름은 자체 문장으로 재서술했다 |
| Who Gossips and How in Everyday Life? | Megan L. Robbins, Alexander Karan | 2020 | All rights reserved (SAGE 구독 저널 — **출판사 1차 페이지 육안 확인 실패**, §4.2 참조. Crossref license 필드에 TDM 라이선스만 있고 CC 표기 없음) | [DOI 10.1177/1948550619837000](https://doi.org/10.1177/1948550619837000) | **§22.31** 일상 험담의 실제 구성 — 467명을 EAR(자연 관찰 녹음)로 관찰해 모은 험담 4,003건 중 **거의 4분의 3이 중립**이었고(부정 604 · 긍정 376), 내용은 대개 '사회적 정보'였다. 사람들은 남 얘기를 평가하려고가 아니라 **전하려고** 한다. gossip 대사가 전부 평가뿐이던 것을 중립적 정보 공유 문장으로 넓힌 근거 | SAGE 구독 저널이고 CC 라이선스 근거가 없다. **보수적으로 전량 유보로 분류**한다 — 이 분류는 재배포를 허용하지 않으므로 오분류의 위험이 없는 방향이다(§4.1이 막으려는 것은 그 반대 방향, 즉 아닌 것을 CC로 잘못 보는 오탐이다). 수치는 저자 소속기관인 UC Riverside의 공식 보도 페이지에서 직접 확인했다 |
| It Doesn't Hurt to Ask: Question-Asking Increases Liking | Karen Huang, Michael Yeomans, Alison Wood Brooks, Julia Minson, Francesca Gino | 2017 | All rights reserved — 조판본 1쪽 "© 2017 American Psychological Association" 및 "This document is copyrighted by the American Psychological Association … intended solely for the personal use of the individual user and is not to be disseminated broadly" 직접 추출 | [DOI 10.1037/pspi0000097](https://doi.org/10.1037/pspi0000097) · [PubMed 28447835](https://pubmed.ncbi.nlm.nih.gov/28447835/) | **§22.29** 후속 질문 — 실제 2인 대화 3건에서 질문을, 특히 앞말을 받아 묻는 후속 질문을 많이 한 사람이 상대에게 더 호감을 샀고, 기제는 반응성(듣기·이해·인정·관심)이었다. 스피드데이팅에서는 후속 질문율이 높은 쪽이 두 번째 만남 승낙을 더 받아냈다. 소식 전달(couple_news)·연인 대화(sweet_talk)의 응답을 맞장구가 아니라 **앞말의 내용을 가리키는 되물음**으로 만든 근거 | APA 저작권. 본문 각주가 **개인적 이용만** 허용하고 광범위한 배포를 명시적으로 배제한다. HBS·DASH의 무료 PDF도 그 사이트에 대한 게시일 뿐 제3자 재배포 권한이 아니다 |
...
| Schmitt-Beck & Schnaudt 2023 | [Springer 논문 페이지](https://link.springer.com/article/10.1007/s11615-023-00462-6) (쿠키 벽 — "open access" 배지는 보이나 CC 문구·저작권 줄이 렌더되지 않음) | **OA 배지만으로 판정하지 않았다**(§4.1). EconStor에 있는 **출판사 조판본 PDF**에서 "Open Access This article is licensed under a Creative Commons Attribution 4.0 International License"와 "© The Author(s) 2023"을 직접 추출해 CC BY 4.0 확인 |
| Robbins & Karan 2020 | [SAGE 논문 페이지](https://journals.sagepub.com/doi/10.1177/1948550619837000) (HTTP 403) | **육안 확인 실패.** OA 사본을 찾지 못했고 Crossref license 필드에는 TDM 라이선스만 있다(CC 없음). 전량 유보로 **보수적 분류**했고, 이 방향은 재배포를 허용하지 않으므로 오분류 위험이 없다. 서지 수치는 저자 소속기관 UC Riverside 공식 보도 페이지에서 직접 확인 |
| Huang et al. 2017 | [APA PsycNet 랜딩 페이지](https://psycnet.apa.org/doiLanding?doi=10.1037%2Fpspi0000097) (JS 로딩 벽 — 본문 미노출) | **조판본 PDF 1쪽의 APA 자체 저작권 고지와 이용 제한 각주를 직접 추출**해 판정 |
