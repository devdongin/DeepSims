...
틱 순서: logic_update 적용 후 일반 입력 전 고용 검증/최초 추첨(id 오름차순),
가구 이동 적용 뒤 다시 검증, 그 뒤 실제 보행/근무. 유효 고용은 두 번째 검사에서
...
resident-local-capacity-proxy를 실제 고용 사업장/관할 인원과 정합시킬 작업이 남아 있다.
