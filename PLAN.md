...
schema68/logic64의 `founding`은 일일 주거 부족 증거와 청원을 영속화한다. 마을 주민 수가
...
**아직 미완료인 경로**: 승인/거부 내구 명령, 현금/부지 예약과 재검증, 기존 성인 주민의
실제 이동·건설, 새 마을의 성립과 자체 정부, 양방향 왕래. 청원 단계만으로 #32를 닫거나
...
비용 차감·부지 예약·인구
이동은 하지 않는 순수 견적이며 내구 승인에 연결하기 전 단계다. 원문의 '자체 시장'은
