...
export const EVENT_TYPES = [
  ...
  'starving', 'lonely', 'argument', 'money_changed', 'welfare_paid', 'wage_shortfall', 'money_shared', 'job_changed', 'died', 'bereaved', 'grew_up', 'public_revenue_remitted', 'invited', 'invite_declined', 'fire_started', 'fire_out', 'heroic_save', 'policy_changed', 'zoned', 'city_promoted', 'item_reported', 'item_returned', 'car_bought', 'petition',
