...
// 생성 풀에서 빼두면 eligible 길이가 예전과 같아 worldgen·이민 RNG가 불변이다.
export const BIRTH_STAGE_OCCUPATIONS = ['child'];
...
export function occupationAllowed(occupation, age) {
  if (occupation === 'chef' || occupation === 'clerk') return age >= 19 && age < 65;
