...
const QA_CHAINS = {
  // §22.44 굶주림·외로움·이웃·복지·정책·물가·연애·이별
  ...
  '동네에 새로 온 사람이 있더라': [[4, '누구?'], [3, '나도 봤어'], [2, '인사는 했어?'], [1, '또 늘었어?']],
  ...
  '좋아하는 사람이 생겼어': [[4, '누군데'], [3, '오 진짜?'], [2, '말은 했어?'], [1, '또?']],
  '아직 정리가 안 됐어': [[4, '시간이 좀 걸리지'], [3, '천천히 해'], [2, '얘기 들어줄게'], [1, '그럴 만해']],
