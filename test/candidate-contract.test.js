...
//   #32 개척/행정 저장은 mood.baseline 위에 schema72/logic71로 통합했다. main 대비
//     후보·선택·이벤트는 동일하며 개척 관측/저장 필드 때문에 world 해시만 갱신한다.
for (const [pop, expected] of [
  [10, ['0ab9198a', '32b2391b', 'ddff0557', 'c84fdf9c']],
  [50, ['5786ecd1', '9a3cd25b', '7885fc6a', 'd5ffb0aa']],
  [200, ['5dad1750', '0928031a', 'e157d46b', '02f3fb8d']],
]) {
