...
test('unlocked station uses current server price and describes the reachable-pair service requirement',async()=>{
  ...
  assert.match(element('zone-info').textContent,/연결 가능한 역 2곳부터 무료 셔틀 운행/);
